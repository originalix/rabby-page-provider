...
const switchChainNotice = (chain) => {
    ...
    const rawContent = `<img style="width: 20px; height: 20px; margin-right: 8px; margin-bottom:0px;" src="${img$2}"/> <div style="color: #192945; padding-right: 2px;">Network switched to <span class="rabby-strong" style="margin: 0;">${chain === null || chain === void 0 ? void 0 : chain.name}</span><div>`;
...
class EthereumProvider extends events.EventEmitter {
    constructor({ maxListeners = 100, isEip6963 = true, isMetamaskMode = false, } = {}) {
        super();
        this.chainId = null;
        ...
        this._switchCurrentProvider = (current) => {
            ...
            Object.defineProperty(current, "request", {
                value: new Proxy(current.request, {
                    apply: async (target, thisArg, argArray) => {
                        const data = argArray === null || argArray === void 0 ? void 0 : argArray[0];
                        if ((data === null || data === void 0 ? void 0 : data.method) == "wallet_revokePermissions") {
...
requestProviderConfig().then(({ rdns, isMetamaskMode }) => {
    ...
    const currentProvider = rdns
        ? (_a = rabbyEthereumProvider.eip6963ProviderDetails.find((item) => {
    ...
    rabbyEthereumProvider.on("rabby:providerChanged", ({ rdns }) => {
        var _a;
        rabbyEthereumProvider._switchCurrentProvider((_a = rabbyEthereumProvider.eip6963ProviderDetails.find((item) => {
            return item.info.rdns === rdns;
        })) === null || _a === void 0 ? void 0 : _a.provider);
    });
    ...
    rabbyEthereumProvider._cacheRequestsBeforeReady.forEach(({ resolve, reject, data }) => {
        window.ethereum
            .request(data)
            .then(resolve)
            .catch(reject);
